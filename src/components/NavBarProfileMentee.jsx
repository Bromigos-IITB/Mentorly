...
// Correct navigation items based on your video
const navItems = [
  { label: "Home", path: "/home" },
  { label: "My Events", path: "/events" },
  { label: "Progress", path: "/progress" }, // Added Progress
  { label: "Messages", path: "/messages" }, // Added Messages
];

export default function NavBarProfileMentee(props) {
  const { window } = props;
